...
class Trip(models.Model):
    class Status(models.TextChoices): PLANNING='planning'; ACTIVE='active'; CLOSED='closed'; ARCHIVED='archived'
    ...
    class Meta: indexes=[models.Index(fields=['owner','status']), models.Index(fields=['destination','start_date'])]
...
class TripMember(models.Model):
    ...
    class Meta: unique_together=[('trip','user')]; indexes=[models.Index(fields=['trip','role']), models.Index(fields=['user','is_active'])]
...
class TripInvitation(models.Model):
    ...
    created_at=models.DateTimeField(auto_now_add=True); updated_at=models.DateTimeField(auto_now=True)
    class Meta: unique_together=[('trip','invited_user')]; indexes=[models.Index(fields=['trip','status']), models.Index(fields=['invited_user','status'])]
