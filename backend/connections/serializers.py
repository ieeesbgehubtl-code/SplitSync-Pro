...
class FriendSerializer(serializers.ModelSerializer):
    ...
    mutual_trips = serializers.IntegerField(read_only=True, default=0)
    total_shared_expenses = serializers.DecimalField(
        max_digits=12, decimal_places=2, read_only=True, default=0
    )

    class Meta:
        model = Friend
        fields = ["id", "friend", "created_at", "mutual_trips", "total_shared_expenses"]
